...
$config = Join-Path $repoRoot "configs\wb_microjepa_0k_braingraph_soft_curriculum.yaml"
$runDir = Join-Path $repoRoot "runs\wb_microjepa_0k_braingraph_soft_curriculum"
$summaryOut = Join-Path $repoRoot "runs\wb_microjepa_0k_frontier_compare.csv"
...
& $python -m src.wb_microjepa.compare_frontier `
  ...
  (Join-Path $repoRoot "runs\wb_microjepa_0j_braingraph_staged_curriculum") `
  --output $summaryOut
